...
Shader "Farl/ShaderSupportTimescale"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_PannerSpeed("Panner Speed", Vector) = (1,1,0,0)
		_MainTex("MainTex", 2D) = "white" {}
		[Toggle(_USEREALTIME_ON)] _UseRealTime("UseRealTime", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _USEREALTIME_ON
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				#ifdef _USEREALTIME_ON
				float staticSwitch28 = _RealTime;
				#else
				float staticSwitch28 = _TimeParameters.x;
				#endif
				float2 uv_MainTex = IN.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 panner11 = ( staticSwitch28 * _PannerSpeed + uv_MainTex);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _MainTex, panner11 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
35;539;1179;421;1661.302;161.9717;1.712569;True;False
Node;AmplifyShaderEditor.SimpleTimeNode;19;-953.4334,318.8382;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-962.5331,399.0379;Inherit;False;Global;_RealTime;_RealTime;2;0;Create;True;0;0;0;False;0;False;0;280.1674;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;16;-1029.834,-80.2618;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;0;False;0;False;None;e199ee8112362864f831425463b09fda;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;12;-759.2108,50.89249;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;28;-750.328,370.8625;Inherit;False;Property;_UseRealTime;UseRealTime;2;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-302.3331,31.53819;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;14;-745.1107,174.2925;Inherit;False;Property;_PannerSpeed;Panner Speed;0;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.PannerNode;11;-506.6294,84.7677;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=1EC9FCED56425226122F8E29AF7CD4D111A2FC77