Shader  /*ase_name*/"Hidden/Universal/Decals_FogAndLightingOptions"/*end*/
{
	/**
	...
	**/
    ...
    SubShader
    {
		/*ase_subshader_options:Name=Additional Options
			Option:Lighting On:false,true:true
				true:SetDefine:ASE_PBR 1
				false:RemoveDefine:ASE_PBR 1
		...
		*/
        ...
        { 
			...
			)
			{
				...
				float3 tmp = /*ase_frag_out:Base Color;Float3;0;-1;_BaseColor*/IsGammaSpace() ? float3(0.5, 0.5, 0.5) : SRGBToLinear(float3(0.5, 0.5, 0.5))/*end*/;
