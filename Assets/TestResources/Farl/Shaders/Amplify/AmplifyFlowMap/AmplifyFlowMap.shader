...
Shader "Custom/Farl/Amplify/AmplifyFlowMap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode130 = tex2D( _FlowMap, uv_FlowMap );
			float mulTime7_g92 = _Time.y * _TimeScale;
			float temp_output_8_0_g92 = frac( mulTime7_g92 );
			float temp_output_29_0_g92 = _FlowStrength;
			float4 lerpResult26_g92 = lerp( tex2D( _BumpTex, ( uv_BumpTex + ( (float2( -1,-1 ) + ((tex2DNode130).rg - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) * temp_output_8_0_g92 * temp_output_29_0_g92 ) ) ) , tex2D( _BumpTex, ( uv_BumpTex + ( (float2( -1,-1 ) + ((tex2DNode130).rg - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) * frac( ( mulTime7_g92 + 0.5 ) ) * temp_output_29_0_g92 ) ) ) , ( abs( ( -temp_output_8_0_g92 + 0.5 ) ) * 2.0 ));
			float3 normal80 = UnpackNormal( lerpResult26_g92 );
			o.Normal = normal80;
			float2 uv_MainTex = i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw;
			float mulTime7_g93 = _Time.y * _TimeScale;
			float temp_output_8_0_g93 = frac( mulTime7_g93 );
			float temp_output_29_0_g93 = _FlowStrength;
			float4 lerpResult26_g93 = lerp( tex2D( _MainTex, ( uv_MainTex + ( (float2( -1,-1 ) + ((tex2DNode130).rg - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) * temp_output_8_0_g93 * temp_output_29_0_g93 ) ) ) , tex2D( _MainTex, ( uv_MainTex + ( (float2( -1,-1 ) + ((tex2DNode130).rg - float2( 0,0 )) * (float2( 1,1 ) - float2( -1,-1 )) / (float2( 1,1 ) - float2( 0,0 ))) * frac( ( mulTime7_g93 + 0.5 ) ) * temp_output_29_0_g93 ) ) ) , ( abs( ( -temp_output_8_0_g93 + 0.5 ) ) * 2.0 ));
			float4 color17 = lerpResult26_g93;
...
/*ASEBEGIN
Version=15001
35;384;1293;345;4144.303;1157.799;1.411802;True;True
Node;AmplifyShaderEditor.CommentaryNode;125;-4843.389,-606.4722;Float;False;776.3998;453.7588;Comment;6;130;142;144;156;158;159;Flow Map;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SwizzleNode;159;-4325.006,-401.4688;Float;False;FLOAT2;0;1;2;2;1;0;COLOR;0,0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;67;-3714.886,274.9777;Float;True;Property;_BumpTex;Normal Map;1;1;[Normal];Create;False;0;0;False;0;None;f5453dca2ac649e4182c56a3966ad395;True;bump;Auto;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.FunctionNode;148;-3324.439,184.6382;Float;False;FlowMap;-1;;92;2217becc26828db4ab706ea4a37b9140;0;4;28;SAMPLER2D;;False;55;FLOAT2;0,0;False;29;FLOAT;0.1;False;30;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;149;-3320.339,-219.1525;Float;False;FlowMap;-1;;93;2217becc26828db4ab706ea4a37b9140;0;4;28;SAMPLER2D;;False;55;FLOAT2;0,0;False;29;FLOAT;0.1;False;30;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;147;-4228.072,-166.6175;Float;False;Property;_Float0;Float 0;6;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
WireConnection;159;0;130;0
WireConnection;142;0;159;0
WireConnection;145;0;142;0
WireConnection;148;28;67;0
WireConnection;148;55;145;0
WireConnection;148;29;41;0
WireConnection;148;30;10;0
WireConnection;149;28;79;0
WireConnection;149;55;145;0
WireConnection;149;29;41;0
WireConnection;149;30;10;0
WireConnection;77;0;148;0
WireConnection;80;0;77;0
WireConnection;17;0;149;0
...
ASEEND*/
//CHKSM=E75FBF9D062DC9487406A5EA0C5868A092B4CC9A