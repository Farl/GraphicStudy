	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float4 appendResult15 = (float4(( uv_MainTex.x / 2 ) , uv_MainTex.y , 0 , 0));
				#ifdef _SINGLE_PASS_VR_ON
				float4 staticSwitch29 = appendResult15;
				#else
				float4 staticSwitch29 = float4( uv_MainTex, 0.0 , 0.0 );
				#endif
				float4 appendResult18 = (float4(( uv_MainTex.x / 2 ) , uv_MainTex.y , 0 , 0));
				#ifdef _SINGLE_PASS_VR_ON
				float4 staticSwitch30 = appendResult18;
				#else
				float4 staticSwitch30 = float4( uv_MainTex, 0.0 , 0.0 );
				#endif
...
/*ASEBEGIN
Version=15001
2213;415;1620;736;1717.425;635.1826;1.3;True;True
Node;AmplifyShaderEditor.CustomTextureCoordinatesNode;24;-1240.706,-25.08808;Float;False;0;9;2;_MainTex;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CustomTextureCoordinatesNode;23;-1219.938,-277.5269;Float;False;0;13;2;_MainTex;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;16;-632.0446,-329.3428;Float;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;17;-639.0292,-73.89848;Float;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;3;-565.4276,-591.5393;Float;False;0;0;_MainTex;Shader;0;5;SAMPLER2D;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F3755C6A41E2ED25E38A64EE3BF527D41211D865