...
Shader "Custom/Farl/Amplify/AmplifyLineWave"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float temp_output_3_0_g1 = ( 0.5 - saturate( pow( ( abs( ( ( uv_TexCoord5.y + ( ( (ripple9).g - 0.5 ) * _WaveScale ) ) - 0.5 ) ) * _LineParam ) , _LinePower ) ) );
...
/*ASEBEGIN
Version=15001
484;327;956;573;2400.689;3.762852;1;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;11;-2290.223,207.6823;Float;False;9;0;1;COLOR;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;13;-2114.088,233.1859;Float;False;False;True;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1859.689,358.2372;Float;False;Property;_WaveScale;Wave Scale;3;0;Create;True;0;0;False;0;0;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=F68A44A246FCB9C4CE202EA236AA2A489203035C