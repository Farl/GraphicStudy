Shader "Custom/Farl/Raymarching"
{
	Properties
	{
		...
		_Center2 ("Center 2", Vector) = (0, 0, 0)
		_Size2 ("Size 2", Vector) = (1, 1, 1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				float v1 = sdf_lerp(
				sdf_sphere(worldPos, _Center, _Size.x),
				sdf_boxcheap(worldPos, _Center, _Size),
				(sin(_Time * 20)) );
