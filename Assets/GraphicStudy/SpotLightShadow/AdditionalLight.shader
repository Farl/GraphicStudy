...
Shader "AdditionalLight"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEEnd][ASEBegin]_MainTex("Main Tex", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 AdditionalLightsHalfLambertMask( float3 WorldPosition, float3 WorldNormal, float4 ShadowMask )
			{
				float3 Color = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 WorldPosition56_g1 = worldPosValue44_g1;
				float3 ase_worldNormal = IN.ase_texcoord4.xyz;
				float3 worldNormalValue50_g1 = ase_worldNormal;
				float3 WorldNormal56_g1 = worldNormalValue50_g1;
				float4 shadowMaskValue33_g1 = float4(1,1,1,1);
				float4 ShadowMask56_g1 = shadowMaskValue33_g1;
				float3 localAdditionalLightsHalfLambertMask56_g1 = AdditionalLightsHalfLambertMask( WorldPosition56_g1 , WorldNormal56_g1 , ShadowMask56_g1 );
				float3 halfLambertResult58_g1 = localAdditionalLightsHalfLambertMask56_g1;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( tex2D( _MainTex, uv_MainTex ) * float4( halfLambertResult58_g1 , 0.0 ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19002
132;273;1573;870;1344.5;292;1;True;False
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-120.5,66;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;12;-503.5,-81;Inherit;True;Property;_MainTex;Main Tex;0;0;Create;True;0;0;0;False;0;False;-1;None;3a9b50088d85baf4b9bdb204225d1867;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldNormalVector;14;-784.5,115;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;10;-577.5,170;Inherit;False;SRP Additional Light;-1;;1;6c86746ad131a0a408ca599df5f40861;7,6,1,9,1,23,1,26,1,27,1,24,1,25,1;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
