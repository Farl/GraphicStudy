Shader /*ase_name*/ "Hidden/Universal/PBR_Farl" /*end*/
{
	Properties
	{
		/*ase_props*/
	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			Option:Test Options:false,true:true
				true:ShowPort:Forward:Test
				false:HidePort:Forward:Test
		...
		*/
		...
		Pass
		{
						...
						/*ase_frag_input*/ ) : SV_Target
			{
				...
				float3 Test = /*ase_frag_out:Test;Float3;20;-1;_Test*/1/*end*/;
